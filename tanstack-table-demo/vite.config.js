...
export default ({ command, mode }) => {
  const sjs =
    mode == "production"
      ? path.resolve(__dirname, "target/scala-3.2.0/tanstacktabledemo-opt/")
      : path.resolve(__dirname, "target/scala-3.2.0/tanstacktabledemo-fastopt/");
  ...
  return {
    root: "tanstack-table-demo/src/main/webapp",
    resolve: {
      alias: [
        {
          find: "@sjs",
